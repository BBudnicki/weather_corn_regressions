...
ggplot(winneYield) +
  ...
  geom_line(mapping = aes(x = year, y = quad, col='Quadratic Time Model')) +
  geom_line(mapping = aes(x = year, y = lin, col='Linear Time Model')) +
  theme_bw() +
...
ggplot(winneYieldTemp) +
  ...
  geom_line(mapping = aes(x = meanTmax, y = tempLin, col="Linear Temp Model")) +
  geom_line(mapping = aes(x = meanTmax, y = yearLin, col="Linear Temp Year Model")) +
  geom_line(mapping = aes(x = meanTmax, y = yearTempQuad, col="Quadratic Temp Year Mode")) +
  theme_bw() +
...
ggplot(winneYieldTemp) +
  ...
  geom_line(mapping = aes(x = year, y = tempLin, col="Linear Temp Model")) +
  geom_line(mapping = aes(x = year, y = yearLin, col="Linear Temp Year Model")) +
  geom_line(mapping = aes(x = year, y = yearTempQuad, col="Quadratic Temp Year Model")) +
  theme_bw() +
  labs(x = "Year", y = "Yield (bsh/ac)", title= "Yield over time", subtitle="Winneshiek, IA")
...
ggplot(iowa) +
  ...
  theme_bw() +
  labs(x = "Actual Yield", y = "Fited Yield", title= "Quadratic Temp Model VS Actual", subtitle="Iowa All Years")
,
ggplot(iowa) +
  geom_point(mapping = aes(x = yield, y = m_yearSq), alpha = 0.2) + 
  geom_line(mapping = aes(x = yield, y = yield), linetype = "dashed") +
  theme_bw() +
  labs(x = "Actual Yield", y = "Fited Yield", title= "Quadratic Year Model VS Actual", subtitle="Iowa All Years")
,
ggplot(iowa) +
  geom_point(mapping = aes(x = yield, y = m_county), alpha = 0.2) + 
  geom_line(mapping = aes(x = yield, y = yield), linetype = "dashed") +
  theme_bw() +
  labs(x = "Actual Yield", y = "Fited Yield", title= "County Model VS Actual", subtitle="Iowa All Years")
,
ggplot(iowa) +
  geom_point(mapping = aes(x = yield, y = m_combined), alpha = 0.2) + 
  geom_line(mapping = aes(x = yield, y = yield), linetype = "dashed") +
  theme_bw() +
  labs(x = "Actual Yield", y = "Fited Yield", title= "Combined Model VS Actual", subtitle="Iowa All Years")
...
ggplot(iowa) +
  ...
  geom_line(mapping = aes(x = yield, y = yield), linetype = "dashed") +
    ...
    theme_bw() +
  labs(x = "Actual Yield", y = "Fited Yield", title= "Quadratic Temp, County Model VS Actual", subtitle="Iowa All Years")
,
ggplot(iowa) +
  ...
  geom_line(mapping = aes(x = yield, y = yield), linetype = "dashed") +
    ...
    theme_bw() +
  labs(x = "Actual Yield", y = "Fited Yield", title= "Quadratic Temp, Quadratic Year, County Model VS Actual", subtitle="Iowa All Years")
...
plot_temp = ggplot(soy) +
  geom_point(mapping = aes(x = meanTmax, y = yield), alpha = 0.4, colour = "black") +
  geom_line(mapping = aes(x = meanTmax, y = m_tmax_quad, colour="Quadratic")) +
  geom_line(mapping = aes(x = meanTmax, y = m_tmax_lin, colour="Linear")) +
  theme_bw() +
  labs(x = "T Max (°C)", y = "Yield (bsh/ac)", title= "Yield over T Max")

plot_year = ggplot(soy) +
  geom_point(mapping = aes(x = year, y = yield), alpha = 0.4, colour = "black") +
  geom_line(mapping = aes(x = year, y = m_year_quad, colour="Quadratic")) +
  geom_line(mapping = aes(x = year, y = m_year_lin, colour="Linear")) +
  theme_bw() +
  labs(x = "Year", y = "Yield (bsh/ac)", title= "Yield over Year")

plot_county = ggplot(soy) +
  geom_point(mapping = aes(x = county_name, y = yield), alpha = 0.4, colour = "black") +
  geom_line(mapping = aes(x = county_name, y = m_county)) +
  theme_bw() +
